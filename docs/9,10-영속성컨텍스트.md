...
<img width="339" height="408" alt="image" src="https://github.com/user-attachments/assets/f1aaf6de-796d-4094-a4d6-10a8f5a3128d" />
...
System.out.println("===============");
```
em.persist를 사용하여 저장해줘야 할거 같지만 아님  
JPA는 변경 감지(Dirty Checking) 기능을 통해 엔티티의 변경 사항을 자동으로 감지하여, 트랜잭션이 끝나는 시점에 적절한 UPDATE 쿼리를 실행

<img width="448" height="426" alt="image" src="https://github.com/user-attachments/assets/f1ca154b-bec1-4475-a550-f70136c76eed" />
